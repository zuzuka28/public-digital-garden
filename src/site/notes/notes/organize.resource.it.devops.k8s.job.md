...
Job создает определенное количество [[notes/organize.resource.it.devops.k8s.pod\|organize.resource.it.devops.k8s.pod]] и смотрит, пока они успешно не завершат работу. 
